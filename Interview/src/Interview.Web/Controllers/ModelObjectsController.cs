...
namespace Interview.Web.Controllers
{
    public class ModelObjectsController : Controller
    {
        ...
        {
            //HttpClient httpClient = clientFactory?.CreateClient("InterviewApi") ?? throw new ArgumentNullException(nameof(clientFactory));
        ...
        public async Task<ActionResult> Index()
        {
            ...
            HttpClient httpClient = ClientFactory.CreateClient("InterviewApi");
